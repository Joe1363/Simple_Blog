...
Branch fb is an experiment using the Facebook graph API. In progress...

Status: All local
Omniauth Facebook sign in: working, tested
Sharing links to Facebook: working, not tested
